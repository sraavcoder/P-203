...
class GUI:
    ...
    def layout(self, name):
        ...
        self.entryMsg.place(relwidth=0.74, rely=0.01, relx=0.011, relheight=0.06)   
        self.entryMsg.focus()

        self.buttonMsg = Button(self.labelBottom, text="Send", width=20, bg="#ABB2B9", command=lambda: self.sendButton(self.entryMsg.get()))
        self.buttonMsg.place(relx=0.77, rely=0.008, relwidth=0.22, relheight=0.06)
